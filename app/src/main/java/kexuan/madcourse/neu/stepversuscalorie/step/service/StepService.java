package kexuan.madcourse.neu.stepversuscalorie.step.service;
...
import kexuan.madcourse.neu.stepversuscalorie.activity.MainActivity;
import kexuan.madcourse.neu.stepversuscalorie.step.UpdateUiCallBack;
import kexuan.madcourse.neu.stepversuscalorie.step.accelerometer.StepCount;
import kexuan.madcourse.neu.stepversuscalorie.step.accelerometer.StepValuePassListener;
import kexuan.madcourse.neu.stepversuscalorie.step.bean.StepData;
import kexuan.madcourse.neu.stepversuscalorie.step.utils.DbUtils;
...
public class StepService extends Service implements SensorEventListener {
    ...
    private void initTodayData() {
        ...
        DbUtils.createDb(this, "MyStepCount");
    ...
    private void initNotification() {
        ...
        mBuilder.setContentTitle(getResources().getString(R.string.app_name))
                .setContentText("Today you've walked " + CURRENT_STEP + " steps")
...
//                    Logger.d("重置步数" + StepDcretor.CURRENT_STEP);
    ...
    private void remindNotify() {
        ...
        mBuilder.setContentTitle("Today you've walked " + CURRENT_STEP + " steps.")
                .setContentText("You have " + (Integer.valueOf(plan) - CURRENT_STEP) + " to go！")
                .setContentIntent(hangPendingIntent)
                .setTicker(getResources().getString(R.string.app_name) + "Get up and walk!")//通知首次出现在通知栏，带上升动画效果的
                .setWhen(System.currentTimeMillis())//通知产生的时间，会在通知信息里显示
                .setPriority(Notification.PRIORITY_DEFAULT)//设置该通知优先级
    ...
    private void addBasePedometerListener() {
        ...
        if (isAvailable) {
            Log.v(TAG, "Pedometer works");
        } else {
            Log.v(TAG, "Pedometer doesn't work");
        }
    }
    ...
    public void onDestroy() {
        ...
        Logger.d("stepService shut down");
    }
